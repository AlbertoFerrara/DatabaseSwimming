...
$query=mysql_query("UPDATE Bagnini SET Brevettorilasciatoil='$Brevettorilasciatoil',ScadenzaBrevetto='$ScadenzaBrevetto',NumeroBrevetto='$NumeroBrevetto'   WHERE CodiceID=$CodiceID"); 
...
<table><tr> 
<form action="VisBagnini.php" align="left">
